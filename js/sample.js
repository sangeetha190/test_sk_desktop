...
!(function () {
  ...
  const me = [
    ...
    function (e) {
      ...
      function P() {
        ...
        t.params.uniqueNavElements &&
          ...
          a &&
            ((r = a.querySelector(ie(t.params.scrollbar.dragClass))),
    ...
    function (e) {
      ...
      function P(e) {
        ...
        t.params.cssMode &&
          ((t.wrapperEl.style.overflow = "visible"),
      ...
      const g = (e, t, s) => {
        ...
        S = () => {
          ...
          if (
            ((c = T(c)),
            (u = T(u)),
            c && c.forEach((t) => g(t, r, e.nextSlideMessage)),
        ...
        i("fromEdge toEdge afterInit lock unlock", () => {
          t.params.a11y.enabled &&
            (function () {
              ...
              const { nextEl: e, prevEl: s } = t.navigation;
              s && (t.isBeginning ? (c(s), l(s)) : (u(s), n(s))),
                e && (t.isEnd ? (c(e), l(e)) : (u(e), n(e)));
            })();
        }),
        i("paginationUpdate", () => {
          t.params.a11y.enabled &&
    ...
    function (e) {
      ...
      const a = (e, s) => {
        ...
        i || (i = ue("flip", e, t.isHorizontal() ? "left" : "top")),
          a || (a = ue("flip", e, t.isHorizontal() ? "right" : "bottom")),
        ...
        setTranslate: () => {
          ...
          for (let s = 0; s < e.length; s += 1) {
            ...
            if ((h && f.shadow) || !h) {
              ...
              if ((!e && f.shadow && (e = ue("creative", i)), e)) {
  ...
  function ge(e, t) {
    ...
    Object.keys(t)
      ...
      .forEach((s) => {
        void 0 === e[s]
          ? (e[s] = t[s])
          : fe(t[s]) && fe(e[s]) && Object.keys(t[s]).length > 0
          ? t[s].__swiper__
            ? (e[s] = t[s])
            : ge(e[s], t[s])
          : (e[s] = t[s]);
  ...
  function ye(e, t, s) {
    ...
    return (
      "string" == typeof t &&
        void 0 !== s &&
        l.push({ name: t, value: fe(s) ? { ...s } : s }),
      l.forEach((e) => {
        const t = be.filter((t) => 0 === e.name.indexOf(`${t}-`))[0];
        if (t) {
          const s = ve(t),
            i = ve(e.name.split(`${t}-`)[1]);
          void 0 === a[s] && (a[s] = {}),
            !0 === a[s] && (a[s] = { enabled: !0 }),
            (a[s][i] = we(e.value));
        } else {
  ...
  class Me extends Ee {
    ...
    initialize() {
      ...
      this.initialized = !0;
      const { params: t, passedParams: s } = ye(this);
      (this.swiperParams = t),
        (this.passedParams = s),
        delete this.swiperParams.init,
        this.render(),
        (this.swiper = new te(this.shadowRoot.querySelector(".swiper"), {
          ...(t.virtual
            ? {}
    ...
    updateSwiperOnPropChange(e, t) {
      const { params: s, passedParams: i } = ye(this, e, t);
      (this.passedParams = i),
        (this.swiperParams = s),
  ...
  "undefined" != typeof window &&
    ...
    "undefined" != typeof window &&
      (window.customElements.get("swiper-container") ||
        window.customElements.define("swiper-container", Me),
      window.customElements.get("swiper-slide") ||
        window.customElements.define("swiper-slide", Ce));
})();
