...
const sliderContainer = document.querySelector(".wrapper-scroll .d-flex");
...
function handleScroll() {
  // Show button if scrolled more than 100 pixels
